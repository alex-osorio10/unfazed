...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var btns = document.querySelectorAll(".subscribe-button"); // Update to only target subscribe buttons
    ...
    // Update the "Shop Now" button click handler to open shop.html
    var shopNowBtn = document.querySelector(".shop-now");
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var modal = document.getElementById("subscribeModal");
    var subscribeBtns = document.querySelectorAll(".subscribe-now, .subscribe-button"); // Update to only target subscribe buttons
    var span = document.getElementsByClassName("close")[0];
    var emailInput = document.getElementById("email");

    // When the user clicks the subscribe button, open the modal and clear the input field
